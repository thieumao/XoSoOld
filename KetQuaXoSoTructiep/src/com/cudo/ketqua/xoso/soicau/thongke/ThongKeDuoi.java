...
public class ThongKeDuoi extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_thong_ke_duoi);
		this.getWindow().setSoftInputMode(
				WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);

		spVung = (Spinner) findViewById(R.id.spinnerVungDuoi);
		spGiai = (Spinner) findViewById(R.id.spinnerGiaiDuoi);
		etLanQuay = (EditText) findViewById(R.id.editTextLanQuayDuoi);
		btThongKe = (Button) findViewById(R.id.buttonThongKeDuoi);
		tvServerTraVe = (TextView) findViewById(R.id.tvServerTraVeDuoi);
		lvMain = (ListView) findViewById(R.id.lvMainDuoi);
		...
		btThongKe.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				hideSoftKeyboard(ThongKeDuoi.this);
				if (KiemTraMang(getApplicationContext())) {
					new ChayNgam().execute("");
				} else {
					Toast.makeText(ThongKeDuoi.this,
	...
	class ChayNgam extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = new ProgressDialog(ThongKeDuoi.this);
		...
		protected Void doInBackground(String... params2) {
			if (KiemTraMang(getApplicationContext())) {
				...
				// Duoiduoi=duoi&vung=xo-so-mien-bac&loai=lo&limit=100
		...
		protected void onPostExecute(Void result) {
			...
			if (checkSuccess.equals("1")) {
				...
				adapter = new ThongKeMyAdapter(ThongKeDuoi.this,
