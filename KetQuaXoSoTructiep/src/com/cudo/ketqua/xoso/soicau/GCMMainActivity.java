...
import static com.cudo.ketqua.xoso.soicau.GCMCommonUtilities.DISPLAY_MESSAGE_ACTION;
import static com.cudo.ketqua.xoso.soicau.GCMCommonUtilities.EXTRA_MESSAGE;
...
//			alert.showAlertDialog(GCMMainActivity.this,
...
//		email = i.getStringExtra("email");
		...
		name = sDeviceID;
		email = GCMGetInfoUser.getEmail(this);	
			...
			if (GCMRegistrar.isRegisteredOnServer(this)) {
				...
				mRegisterTask = new AsyncTask<Void, Void, Void>() {
					...
					protected Void doInBackground(Void... params) {
						...
						GCMServerUtilities.register(context, name, email, regId);
						return null;
					}
	...
	private final BroadcastReceiver mHandleMessageReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			GCMWakeLocker.acquire(getApplicationContext());
